...
updates_dir=/data/StyxOS_updates
...
adb shell "killall org.styxproject.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.styxproject.updater/databases/updates.db" \
